...
function transform() {
    ...
    const step1 = [
        {"bothPostive": `x² + ${coeffX}x + y² + ${coeffY}y = ${constant / -1}`},
        {"xPostive" : `x² + ${coeffX}x + y² ${coeffY}y = ${constant / -1}`},
        {"yPositive" : `x² ${coeffX}x + y² + ${coeffY}y = ${constant / -1}`},
        {"bothNegative" : `x² ${coeffX}x + y² ${coeffY}y = ${constant / -1}`}
    ]

    const step2 = [
        {"bothPostive": `x² + ${coeffX}x + ${xpow} + y² + ${coeffY}y + ${ypow} = ${constant / -1} + ${xpow} + ${ypow}`},
        {"xPostive" : `x² + ${coeffX}x + ${xpow} + y² ${coeffY}y + ${ypow} = ${constant / -1} + ${xpow} + ${ypow} `} ,
        {"yPositive" : `x² ${coeffX}x + ${xpow} + y² + ${coeffY}y + ${ypow} = ${constant / -1} + ${xpow} + ${ypow}`},
        {"bothNegative" : `x² ${coeffX}x + ${xpow} + y² ${coeffY}y + ${ypow} = ${constant / -1} + ${xpow} + ${ypow}`}
    ]
