...
function transformSF(){
    ...
    const step2 = [
                  {"bothPositive": `x² + y² + ${coeffX}x + ${coeffY}y + ${constantOfX} + ${constantOfY} ${radiusSign} ${Math.abs(radius)} = 0`},
                  {"xpositive": `x² + y² + ${coeffX}x ${coeffY}y + ${constantOfX} + ${constantOfY} ${radiusSign}  ${Math.abs(radius)} = 0`},
                  {"ypositive": `x² + y² ${coeffX}x + ${coeffY}y + ${constantOfX} + ${constantOfY} ${radiusSign}  ${Math.abs(radius)} = 0`},
                  {"bothNegative": `x² + y² ${coeffX}x ${coeffY}y + ${constantOfX} + ${constantOfY} ${radiusSign} ${Math.abs(radius)} = 0`}
    ];
 ...
 /*FOR TRANSFORMING */
    ...
    if(xVal > 0 && yVal > 0){
        ...
        result.textContent = `x² + y² + ${coeffX}x + ${coeffY}y ${radiusSign} ${radiusOfGf} = 0`;
    }
        ...
        step2Container.textContent = `x² + y² + ${coeffY}y + ${constantOfY} ${radiusSign} ${radius / -1} = 0`;
        ...
        step2Container.textContent = `x² + y² + ${coeffX}x + ${constantOfX} ${radiusSign} ${radius / -1} = 0`;
