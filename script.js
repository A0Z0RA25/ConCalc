...
const circleList = document.querySelector(".transformCircle");
const parabolaList = document.querySelector(".transformParabola");
const ellipseList = document.querySelector(".transformEllipse");
const hyperbolaList = document.querySelector(".transformHyperbola");
